 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://WebServices/", wsdlLocation = "http://localhost:8080/javaserviciocrud/Servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://WebServices/", "Servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/javaserviciocrud/Servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://WebServices/", "ServiciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebServices/", "ServiciosPort"), Servicios.class, features);
    }
